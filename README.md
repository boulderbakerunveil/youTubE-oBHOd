...
# <img src="https://cdn-icons-png.flaticon.com/128/5968/5968756.png" height=28 /> <a href="https://github.com/boulderbakerunveil/">boulderbakerunveil</a><a href="https://github.com/boulderbakerunveil/youTubE-oBHOd">/youTubE-oBHOd</a> <img src="https://cdn-icons-png.flaticon.com/128/1384/1384060.png" height=28 />
...
> Если вы наткнулись на что-то вне репозитория `boulderbakerunveil/youTubE-oBHOd`, что распространяется от моего лица - **ФЕЙК**.
...
2. Скачайте архив (zip/rar) со [страницы последнего релиза](https://github.com/boulderbakerunveil/youTubE-oBHOd/releases/latest)
...
Если этого не произошло, то см. [#522](https://github.com/boulderbakerunveil/youTubE-oBHOd/issues/522)
...
- См. [#765](https://github.com/boulderbakerunveil/youTubE-oBHOd/issues/765)
...
- Скачайте последнюю версию [со страницы релизов](https://github.com/boulderbakerunveil/youTubE-oBHOd/releases/latest) (`zapret-discord-youtube-...`)
...
- См. также [#251](https://github.com/boulderbakerunveil/youTubE-oBHOd/discussions/251)
...
- См. также [#252](https://github.com/boulderbakerunveil/youTubE-oBHOd/discussions/252)
...
Если и это не помогло, создайте ветку обсуждений в разделе [Discussions](https://github.com/boulderbakerunveil/youTubE-oBHOd/discussions) (не в issues) и ждите помощи от других игроков.

### Не нашли своей проблемы

- Создайте её [тут](https://github.com/boulderbakerunveil/youTubE-oBHOd/issues)
...
Проект распространяется на условиях лицензии [MIT](https://github.com/boulderbakerunveil/youTubE-oBHOd/blob/main/LICENSE.txt)
